...
const serverURL = "http://localhost:4001/books";
  ...
  return (
    <div className={classes.pageContainer}>
      ...
      <section className={classes.infoContainer}>
        <h1 className={classes.infoTitle}>Welcome to your own personal Book Nook.</h1>
        <p className={classes.infoText}>Manage and update your personal library effeciently and with ease.</p>
        <UserSignUp />
      </section>
    </div>
  );
